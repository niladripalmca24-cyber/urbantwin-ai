...
CROSS_CAMERA_MATCHES_DB: List[CrossCameraMatch] = [
    CrossCameraMatch(
        ...
        timeline=[
            {"camera_id": "CAM_01", "name": "Financial District", "timestamp": "10:02:01", "speed_kmh": "48.2"},
            {"camera_id": "CAM_03", "name": "Central Junction", "timestamp": "10:07:34", "speed_kmh": "42.0"},
            {"camera_id": "CAM_05", "name": "North Avenue", "timestamp": "10:14:12", "speed_kmh": "39.5"}
        ],
        final_score=0.91,
    ...
    CrossCameraMatch(
        ...
        timeline=[
            {"camera_id": "CAM_02", "name": "Tech Expressway", "timestamp": "10:11:05", "speed_kmh": "64.1"},
            {"camera_id": "CAM_04", "name": "City Harbor Way", "timestamp": "10:18:22", "speed_kmh": "58.0"},
            {"camera_id": "CAM_06", "name": "Suburb Boulevard", "timestamp": "10:25:50", "speed_kmh": "52.3"}
        ],
        final_score=0.88,
        breakdown=MatchBreakdown(
    ...
    CrossCameraMatch(
        ...
        timeline=[
            {"camera_id": "CAM_01", "name": "Financial District", "timestamp": "10:30:10", "speed_kmh": "35.2"},
            {"camera_id": "CAM_02", "name": "Tech Expressway", "timestamp": "10:36:45", "speed_kmh": "51.0"}
        ],
        final_score=0.94,
        breakdown=MatchBreakdown(
